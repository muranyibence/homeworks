...
public class DeviceDB implements Serializable {
    ...
    public DeviceEntity addDevice(DeviceEntity device) throws DeviceAlreadyInDBException {
    ...
    public DeviceEntity getDevice(String id) throws DeviceNotExistInDBException {
    ...
    public void addExistingDevice(String id, int count) throws DeviceNotExistInDBException {
        if (devices.get(id) == null) {
            throw new DeviceNotExistInDBException(DEVICE + id + NOT_EXIST);
        }
    ...
    public DeviceEntity takeDevice(String id, int count) throws NotEnoughCountInDBException, DeviceNotExistInDBException {
        if (devices.get(id) == null) {
    ...
    public DeviceEntity editDevice(DeviceEntity device) throws DeviceNotExistInDBException {
    ...
    public DeviceEntity deleteDevice(DeviceEntity device) throws DeviceNotExistInDBException {
