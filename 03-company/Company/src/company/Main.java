...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Worker w1 = new Worker("Dolgozó1", new Time(1987, 11, 3), Sex.MALE, 0, 100);
        Worker w2 = new Worker("Dolgozó2", new Time(1986, 8, 11), Sex.FEMALE, 50, 80);
        Worker w3 = new Worker("Dolgozó1", new Time(1982, 1, 5), Sex.MALE, 0, 110);

        Boss b1 = new Boss("Boss1", new Time(1966, 2, 5), Sex.MALE, 400, 200);
        Boss b2 = new Boss("Boss2", new Time(1982, 6, 11), Sex.FEMALE, 300, 220);
        //munkások hozzáadása
        c1.addWorker(w1);
        c1.addWorker(w2);
        c2.addWorker(w3);
